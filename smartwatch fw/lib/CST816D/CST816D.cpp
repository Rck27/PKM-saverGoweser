...
void CST816D::begin(void)
{
  ...
  i2c_write(0xFA, 0x20); //int control 7 test, 6 low when touched, 5 when changed
  // i2c_write(0xF6, 0x02); //lp scan  sensitivity
  i2c_write(0xED, 0x32); //Interrupt low-pluse output width Unit: 0.1ms, Range: 1～200, Default:10
}
